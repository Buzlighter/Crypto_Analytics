...
object Constants {
    ...
    const val NEWS_TO_DETAILS_BUNDLE_KEY = "NEWS_TO_DETAILS"

    const val DB_NAME = "crypto_db"
    const val DB_TABLE_NAME_NEWS = "news"


    const val NOTIFICATION_CHANNEL_ID = "CRYPTO_CHANNEL"
    const val NOTIFICATION_CHANNEL_NAME = "GRAPH_VALUES"
    ...
    const val WORKMANAGER_UNIQUE_NAME = "CRYPTO_WORKMANAGER"
    const val CRYPTO_WORKER_KEY = "WORKER_KEY"
    const val WORKER_KEY_ERROR = "WORKER_ERROR_KEY"
